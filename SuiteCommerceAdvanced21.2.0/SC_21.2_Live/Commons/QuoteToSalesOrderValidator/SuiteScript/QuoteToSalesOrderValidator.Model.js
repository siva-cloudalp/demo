...
define('QuoteToSalesOrderValidator.Model', [
    ...
    return SCModel.extend({
        ...
        purchasableQuoteConditions: [
            ...
            },
            {
                ...
                validatesCondtion: function(quote) {
                    return (
                        quote.entitystatus.id === Configuration.get('quote.purchaseReadyStatusId')
                    );
                }
            },
            {
            ...
            },
            {
                ...
                validatesCondtion: function(quote) {
                    const all_items_fulfillable = _.all(
                        _.pluck(quote.lines, 'isfulfillable'),
            ...
            },
            {
                ...
                validatesCondtion: function(quote) {
                    ...
                    const shipping_address = quote.addresses[quote.shipaddress];
        ...
        getQuoteToSalesOrderValidation: function(record, validators) {
            const purchase_validation_errors = [];
            let is_valid_for_purchase = false;
