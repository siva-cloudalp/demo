...
const ApplicationErrorClient: any = {
    ...
    noEnoughFreeSpace: {
        ...
        message: function(space) {
            return Utils.translate(
                'Fallback needs 1 GB to work correctly.To go to Fallback, you must first clear $(0) of device space.',
                space
            );
        }
    },
    outdatedWrapperVersion: {
        ...
        message: Utils.translate(
            'A new version of the SCIS mobile application is available.  Please download and install the update soon.'
        )
    }
};
