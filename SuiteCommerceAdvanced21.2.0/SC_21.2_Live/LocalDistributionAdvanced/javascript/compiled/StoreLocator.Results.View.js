...
*/
define("StoreLocator.Results.View", ["require", "exports", "store_locator_results.tpl", "Utils", "jQuery", "Configuration", "StoreLocator.List.View", "StoreLocator.Map.View", "Backbone.View", "Backbone.CollectionView"], function (require, exports, store_locator_results_tpl, Utils, jQuery, Configuration_1, StoreLocatorListView, StoreLocatorMapView, BackboneView, BackboneCollectionView) {
    "use strict";
    var StoreLocatorResultsView = BackboneView.extend({
    ...
    return StoreLocatorResultsView;
});

//# sourceMappingURL=StoreLocator.Results.View.js.map
