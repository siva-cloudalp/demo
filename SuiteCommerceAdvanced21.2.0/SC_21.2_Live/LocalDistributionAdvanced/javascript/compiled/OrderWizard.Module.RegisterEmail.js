...
*/
define("OrderWizard.Module.RegisterEmail", ["require", "exports", "order_wizard_registeremail_module.tpl", "Utils", "jQuery", "Wizard.StepModule", "Profile.Model", "Backbone"], function (require, exports, order_wizard_registeremail_module_tpl, Utils, jQuery, Wizard_StepModule_1, Profile_Model_1, Backbone) {
    "use strict";
    return Wizard_StepModule_1.WizardStepModule.extend({
        ...
        submit: function () {
            ...
            var emailsubscribe = this.$('input[name=sign-up-newsletter]').is(':checked') ? 'T' : 'F';
        ...
        isActive: function () {
            var configuration = this.wizard.application.getConfig();
            var checkoutConfig = configuration.checkout || {};
...
//# sourceMappingURL=OrderWizard.Module.RegisterEmail.js.map
