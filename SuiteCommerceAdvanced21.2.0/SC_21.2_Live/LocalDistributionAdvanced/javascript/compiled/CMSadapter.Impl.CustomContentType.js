...
*/
define("CMSadapter.Impl.CustomContentType", ["require", "exports", "underscore"], function (require, exports, _) {
    "use strict";
    /*
    @module CMSadapter
    ...
    _.extend(AdapterCustomContentType.prototype, {
        listenForCMS: function listenForCMS() {
            ...
            self.CMS.on('content:add', function (promise, cct) {
                ...
                self.CMSadapterComponent.addContent(content.id, content.instance_id, content.selector, content.settings, content.render_settings).then(promise.resolve, promise.reject);
            });
            self.CMS.on('content:update', function (promise, cct) {
                ...
                self.CMSadapterComponent.updateContent(content.id, content.instance_id, content.selector, content.settings, content.render_settings).then(promise.resolve, promise.reject);
            });
...
//# sourceMappingURL=CMSadapter.Impl.CustomContentType.js.map
