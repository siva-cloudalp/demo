...
*/
define("CustomerPayment.Details.View", ["require", "exports", "underscore", "customer_payment_details.tpl", "Utils", "Configuration", "RecordViews.View", "AjaxRequestsKiller", "GlobalViews.FormatPaymentMethod.View", "CustomerPayment.Model", "Backbone.View", "Backbone", "Backbone.CollectionView"], function (require, exports, _, customer_payment_details_tpl, Utils, Configuration_1, RecordViews_View_1, AjaxRequestsKiller_1, GlobalViewsFormatPaymentMethodView, CustomerPaymentModel, BackboneView, Backbone, BackboneCollectionView) {
    "use strict";
    var CustomerPaymentDetailsView = BackboneView.extend({
        ...
        getContext: function () {
            ...
            return {
                ...
                collapseElements: Configuration_1.Configuration.get('sca.collapseElements'),
    ...
    return CustomerPaymentDetailsView;
});

//# sourceMappingURL=CustomerPayment.Details.View.js.map
