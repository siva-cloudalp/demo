...
*/
define("Content.DataModels", ["require", "exports", "underscore", "Utils", "jQuery", "Configuration", "AjaxRequestsKiller", "Singleton", "Backbone", "Backbone.CachedModel", "Backbone.CachedCollection"], function (require, exports, _, Utils, jQuery, Configuration_1, AjaxRequestsKiller_1, Singleton, Backbone) {
    "use strict";
    var Pages = {};
            ...
            this.each(function (model) {
                ...
                // By comparing one another with other regular expressions (this.insertInGraph)
                    ...
                    _.each(self.regExpGraphHelper, function (currentNode) {
                        if (!_.contains(model.get('childs'), currentNode) &&
    ...
    function loadPage(url, donefn) {
        if (donefn === void 0) { donefn = jQuery.noop; }
        if (url) {
            ...
            if (foundUrl) {
                ...
                var page_id_1 = foundUrl.get('pageid');
                var page_1 = Pages.Collection.getInstance().get(page_id_1);
                if (page_1) {
                    donefn(page_1);
                }
                // We don't have it need to be fetched
                    ...
                    // Fetches the page
                    new Pages.Model({ internalid: page_id_1, id: page_id_1 })
                        .fetch({
                        data: {
                            cache: Configuration_1.Configuration.get('cache.contentPageCdn'),
                            ttl: Configuration_1.Configuration.get('cache.contentPageTtl')
                        },
                        ...
                        page_1 = Pages.Collection.getInstance().get(page_id_1);
                        donefn(page_1);
                    });
                }
            }
...
//# sourceMappingURL=Content.DataModels.js.map
