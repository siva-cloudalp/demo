...
define("Backbone.View.render", ["require", "exports", "underscore", "Utils", "jQuery", "SC.BaseComponent.ChildViewsComponent", "PluginContainer", "Backbone.View", "Backbone.CompositeView", "Backbone.Validation", "Handlebars", "HandlebarsExtras"], function (require, exports, _, Utils, jQuery, SC_BaseComponent_ChildViewsComponent_1, PluginContainer, BackboneView) {
    "use strict";
    /*
        ...
        getTemplateContext: function () {
            ...
            if (this.getContext) {
                ...
                if (!_.isEmpty(contextProperties)) {
                    ...
                    var safe_context_1 = Utils.deepCopy(template_context);
                    _.each(contextProperties, function (propertyGenerator, propertyName) {
                        template_context[propertyName] = propertyGenerator.fn(safe_context_1);
                    });
                }
            }
            else {
...
//# sourceMappingURL=Backbone.View.render.js.map
