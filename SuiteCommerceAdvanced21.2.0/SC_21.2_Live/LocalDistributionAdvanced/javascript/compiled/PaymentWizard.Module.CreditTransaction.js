...
*/
define("PaymentWizard.Module.CreditTransaction", ["require", "exports", "payment_wizard_credit_transaction_module.tpl", "Utils", "jQuery", "Configuration", "Wizard.StepModule", "PaymentWizard.EditAmount.View", "Backbone.CollectionView", "RecordViews.Selectable.View", "PaymentWizard.Module.CreditTransaction.Edit.Action.View", "Backbone", "LivePayment.Model"], function (require, exports, payment_wizard_credit_transaction_module_tpl, Utils, jQuery, Configuration_1, Wizard_StepModule_1, EditAmountView, BackboneCollectionView, RecordViewsSelectableActionableView, PaymentWizardModuleCreditTransactionEditActionView, Backbone, LivePaymentModel) {
    "use strict";
    // @class PaymentWizard.Module.CreditTransaction @extend Wizard.Module
    var PaymentWizardModuleCreditTransaction = Wizard_StepModule_1.WizardStepModule.extend({
        ...
        editTransaction: function (e) {
            var transaction_id = jQuery(e.target)
        ...
        getContext: function () {
            ...
            return {
                ...
                areElementsCollapsed: !!Configuration_1.Configuration.get('sca.collapseElements'),
                // @property {String} totalFormatted
                totalFormatted: this.wizard.model.get(this.transaction_type === 'credit'
                    ? 'credits_total_formatted'
                    : 'deposits_total_formatted')
            };
        }
    });
    return PaymentWizardModuleCreditTransaction;
});

//# sourceMappingURL=PaymentWizard.Module.CreditTransaction.js.map
