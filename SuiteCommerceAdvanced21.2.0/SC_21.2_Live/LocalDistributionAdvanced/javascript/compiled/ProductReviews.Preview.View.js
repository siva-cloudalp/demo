...
*/
define("ProductReviews.Preview.View", ["require", "exports", "underscore", "product_reviews_preview_review.tpl", "Utils", "jQuery", "GlobalViews.Message.View", "GlobalViews.StarRating.View", "Backbone", "Backbone.View", "Backbone.CollectionView", "js.cookie", "Configuration", "ProductReviews.Collection"], function (require, exports, _, product_reviews_preview_review, Utils, jQuery, GlobalViews_Message_View_1, GlobalViewsStarRatingView, Backbone, BackboneView, BackboneCollectionView, Cookies) {
    "use strict";
    return BackboneView.extend({
        ...
        markReview: function (e) {
            ...
            if (!$element.hasClass('disabled')) {
                ...
                review
                    .save()
                    .then(proxy(this.handleMarkSuccess, this, review_id, action, review, $container), proxy(this.handleMarkError, this, $container));
            }
        }
    });
});

//# sourceMappingURL=ProductReviews.Preview.View.js.map
