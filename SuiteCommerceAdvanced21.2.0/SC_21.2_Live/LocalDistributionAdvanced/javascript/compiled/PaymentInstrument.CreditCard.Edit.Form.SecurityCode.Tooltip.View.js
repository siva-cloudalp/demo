...
*/
define("PaymentInstrument.CreditCard.Edit.Form.SecurityCode.Tooltip.View", ["require", "exports", "underscore", "paymentinstrument_creditcard_edit_form_securitycode_tooltip.tpl", "Utils", "Configuration", "Profile.Model", "Backbone.View"], function (require, exports, _, creditcard_edit_form_securitycode_tootltip, Utils, Configuration_1, Profile_Model_1, BackboneView) {
    "use strict";
    // @class PaymentInstrument.CreditCard.Edit.Form.SecurityCode.Tooltip.View @extends Backbone.View
    var PaymentInstrumentCreditCardEditFormSecurityCodeTooltipView = BackboneView.extend({
        ...
        getAvailableCreditcards: function () {
            ...
            if (!creditcards.length) {
                var available_creditcards = _.where(Configuration_1.Configuration.get('siteSettings.paymentmethods'), {
                    creditcard: 'T',
                    ispaypal: 'F'
                });
                _.each(available_creditcards, function (available_creditcard) {
    ...
    return PaymentInstrumentCreditCardEditFormSecurityCodeTooltipView;
});

//# sourceMappingURL=PaymentInstrument.CreditCard.Edit.Form.SecurityCode.Tooltip.View.js.map
