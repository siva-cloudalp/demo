...
*/
define("GlobalViews.Confirmation.View", ["require", "exports", "underscore", "global_views_confirmation.tpl", "Utils", "Backbone.View"], function (require, exports, _, global_views_confirmation_tpl, Utils, BackboneView) {
    "use strict";
    // @class GlobalViews.Confirmation.View @extends Backbone.View
    var GlobalViewsConfirmationView = BackboneView.extend({
    ...
    return GlobalViewsConfirmationView;
});
...
//# sourceMappingURL=GlobalViews.Confirmation.View.js.map
