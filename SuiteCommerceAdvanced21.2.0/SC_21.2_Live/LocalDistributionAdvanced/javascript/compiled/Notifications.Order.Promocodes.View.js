...
*/
define("Notifications.Order.Promocodes.View", ["require", "exports", "notifications_order_promocodes.tpl", "Utils", "GlobalViews.Message.View", "Backbone.View"], function (require, exports, notifications_order_promocodes, Utils, GlobalViews_Message_View_1, BackboneView) {
    "use strict";
    // @class Notification.Order.Promocodes.View @extend Backbone.View
    var NotificationsOrderPromocodesView = BackboneView.extend({
    ...
    return NotificationsOrderPromocodesView;
});

//# sourceMappingURL=Notifications.Order.Promocodes.View.js.map
