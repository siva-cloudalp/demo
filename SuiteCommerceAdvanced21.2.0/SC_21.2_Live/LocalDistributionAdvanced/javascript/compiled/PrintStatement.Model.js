...
*/
define("PrintStatement.Model", ["require", "exports", "Utils", "Backbone.Model", "Backbone.Sync"], function (require, exports, Utils, BackboneModel) {
    "use strict";
    ...
    var PrintStatementModel = BackboneModel.extend({
        validation: {
    ...
    return PrintStatementModel;
});

//# sourceMappingURL=PrintStatement.Model.js.map
