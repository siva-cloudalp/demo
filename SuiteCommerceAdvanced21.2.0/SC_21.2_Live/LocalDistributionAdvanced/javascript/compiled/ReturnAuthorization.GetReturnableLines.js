...
*/
define("ReturnAuthorization.GetReturnableLines", ["require", "exports", "underscore"], function (require, exports, _) {
    "use strict";
    ...
    _.extend(RetrunableLinesCalculator.prototype, {
        ...
        _setFulfilledQuantities: function () {
            ...
            var lines = created_from.get('lines');
            var self = this;
            var fullfilments = created_from.get('fulfillments');
            if (fullfilments) {
            ...
            created_from.get('returnauthorizations').each(function (sibling) {
                if (sibling.get('status').internalid !== 'cancelled') {
                    sibling.get('lines').each(function (line) {
                        ...
                        var same_item_line = lines.find(function (line) {
...
//# sourceMappingURL=ReturnAuthorization.GetReturnableLines.js.map
