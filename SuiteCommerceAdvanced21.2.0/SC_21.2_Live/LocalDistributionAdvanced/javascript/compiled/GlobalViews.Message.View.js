...
*/
define("GlobalViews.Message.View", ["require", "exports", "underscore", "global_views_message.tpl", "Backbone.View"], function (require, exports, _, global_views_message_tpl, BackboneView) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.GlobalViewsMessageView = void 0;
    exports.GlobalViewsMessageView = BackboneView.extend({
        ...
        getContext: function getContext() {
            ...
            var message = has_error_code ? this.options.message.message : this.options.message;
            var errorCode = has_error_code ? this.options.message.errorCode : undefined;
            return {
...
//# sourceMappingURL=GlobalViews.Message.View.js.map
