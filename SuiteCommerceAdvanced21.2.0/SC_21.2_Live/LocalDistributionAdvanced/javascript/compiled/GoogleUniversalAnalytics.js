...
*/
define("GoogleUniversalAnalytics", ["require", "exports", "underscore", "Utils", "jQuery", "Configuration", "Tracker", "Backbone"], function (require, exports, _, Utils, jQuery, Configuration_1, Tracker, Backbone) {
    "use strict";
    return (function (win, name) {
        ...
        var GoogleUniversalAnalytics = {
            ...
            setAccount: function (config) {
                ...
                var domainName = Utils.isCheckoutDomain()
            ...
            mountToApp: function (application) {
                ...
                var tracking = configuration.tracking.googleUniversalAnalytics;
...
//# sourceMappingURL=GoogleUniversalAnalytics.js.map
