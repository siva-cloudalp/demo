...
*/
define("Location", ["require", "exports", "underscore", "jQuery", "Location.Collection", "Location.Model", "Transaction.Model", "js.cookie", "Location.ProductLine"], function (require, exports, _, jQuery, LocationCollection, LocationModel, TransactionModel, Cookies) {
    "use strict";
    var locations_cache = {};
        ...
        mountToApp: function mountToApp() {
            ...
            TransactionModel.prototype.initialize = function initialize() {
                ...
                this.on('change:lines', function (model) {
                    var default_location_id = Cookies.get('myStore');
                    var lines = model.get('lines');
                    var is_cart = this.get('internalid') === 'cart';
                    var location_ids = lines.map(function (line) {
                    ...
                    fetchLocations(location_ids).done(function () {
                        lines.each(function (line) {
                            var internalid = (line.get('location') && line.get('location').get('internalid')) ||
