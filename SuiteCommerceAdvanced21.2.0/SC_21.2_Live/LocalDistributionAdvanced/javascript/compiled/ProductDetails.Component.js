...
*/
define("ProductDetails.Component", ["require", "exports", "underscore", "Utils", "jQuery", "SC.VisualComponent"], function (require, exports, _, Utils, jQuery, SCVisualComponent) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ProductDetailsComponent = void 0;
    var ProductDetailsComponent = function ProductDetailsComponentGenerator(application) {
        ...
        var privateComponent = SCVisualComponent.extend({
            ...
            getPrice: function getPrice() {
                var current_view = this.viewToBeRendered || application.getLayout().getCurrentView();
                if (this._isViewFromComponent(current_view, true)) {
                    var priceData = current_view.model.getPrice();
                    if (priceData) {
        ...
        var _normalizeGetPrice = function _normalizeGetPrice(priceData) {
            var price = priceData.price, price_formatted = priceData.price_formatted, compare_price = priceData.compare_price, compare_price_formatted = priceData.compare_price_formatted;
            return {
                price: price,
                price_formatted: price_formatted,
                compare_price: compare_price,
                compare_price_formatted: compare_price_formatted,
            };
        };
        var _normalizeChangeOptionBefore = function _normalizeChangeOptionBefore(optionCartId, value) {
            return { optionCartId: optionCartId, value: value };
        };
        var _normalizeChangeOptionAfter = function _normalizeChangeOptionAfter(data) {
            return {
        ...
        var _normalizebeforeImageChange = function _normalizebeforeImageChange(data) {
            return {
