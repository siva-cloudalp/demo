...
*/
define("LiveOrder.Line.Model", ["require", "exports", "underscore", "Utils", "Transaction.Line.Model"], function (require, exports, _, Utils, TransactionLineModel) {
    "use strict";
    var LiveOrderLineModel = TransactionLineModel.extend({
        ...
        initialize: function initialize() {
            ...
            this.on('error', function (model, jqXhr) {
                ...
                var error_details = result.errorDetails;
        ...
        isEqual: function isEqual(other_line) {
            var otherLineFulfillmentChoice = this.get('options').length ?
...
//# sourceMappingURL=LiveOrder.Line.Model.js.map
