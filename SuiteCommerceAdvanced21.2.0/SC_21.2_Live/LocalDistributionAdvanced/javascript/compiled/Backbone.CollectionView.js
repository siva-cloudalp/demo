...
*/
define("Backbone.CollectionView", ["require", "exports", "underscore", "jQuery", "Backbone", "Backbone.View", "PluginContainer"], function (require, exports, _, jQuery, Backbone, BackboneView, PluginContainer) {
    "use strict";
    var classProperties = {
        postRowCompile: new PluginContainer()
    };
    var BackboneCollectionView = BackboneView.extend({
        ...
        createChildElement: function () {
            ...
            var element = jQuery("<" + tag_name + "></" + tag_name + ">");
            if (data.childId) {
        ...
        generateCellContext: function (child_view_instance) {
            var child_view_instance_context = child_view_instance.getTemplateContext
        ...
        createCell: function (model, index) {
            ...
            var child_view_instance = new this.childView(options);
            this.childCells.push(child_view_instance);
            if (!(child_view_instance.attributes &&
        ...
        appendCellsToRow: function (cells) {
            ...
            if (this.rowTemplate) {
                var tmpl_str = this.rowTemplate(this.generateRowContext());
                BackboneCollectionView.postRowCompile.executeAll(tmpl_str, this);
                var $row = jQuery(tmpl_str);
...
//# sourceMappingURL=Backbone.CollectionView.js.map
