...
*/
define("Wizard.StepNavigation.View", ["require", "exports", "underscore", "wizard_step_navigation.tpl", "Backbone", "Backbone.View"], function (require, exports, _, wizard_step_navigation_tpl, Backbone, BackboneView) {
    "use strict";
    // @class Wizard.StepNavigation.View @extends Backbone.View
    var WizardStepNavigationView = BackboneView.extend({
    ...
    return WizardStepNavigationView;
});

//# sourceMappingURL=Wizard.StepNavigation.View.js.map
