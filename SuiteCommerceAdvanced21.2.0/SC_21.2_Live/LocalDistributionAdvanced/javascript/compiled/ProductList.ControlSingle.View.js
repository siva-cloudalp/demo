...
*/
define("ProductList.ControlSingle.View", ["require", "exports", "underscore", "product_list_control_single.tpl", "Utils", "Backbone.View", "ProductList.Item.Collection", "ProductList.Control.View", "Backbone.View.render"], function (require, exports, _, product_list_control_single_tpl, Utils, BackboneView, ProductListItemCollection, ControlView) {
    "use strict";
    return BackboneView.extend({
        ...
        getProductsInternalid: function () {
            return _.map(this.single_list.get('items').models, function (item) {
        ...
        renderAfterAdded: function (self) {
            ...
            self.render();
            self.saveAndShowConfirmationMessage(Utils.translate('Good! You added this item to your product list'));
...
//# sourceMappingURL=ProductList.ControlSingle.View.js.map
