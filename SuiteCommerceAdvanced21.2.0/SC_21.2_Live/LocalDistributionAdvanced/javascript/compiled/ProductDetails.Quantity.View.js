...
*/
define("ProductDetails.Quantity.View", ["require", "exports", "product_details_quantity.tpl", "Backbone.View"], function (require, exports, product_details_quantity_tpl, BackboneView) {
    "use strict";
    // @class ProductDetails.Quantity.View @extends Backbone.View
    var ProductDetailsQuantityView = BackboneView.extend({
    ...
    return ProductDetailsQuantityView;
});

//# sourceMappingURL=ProductDetails.Quantity.View.js.map
