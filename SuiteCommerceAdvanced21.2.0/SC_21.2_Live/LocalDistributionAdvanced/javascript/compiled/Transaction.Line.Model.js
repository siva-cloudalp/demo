...
*/
define("Transaction.Line.Model", ["require", "exports", "underscore", "Item.Model", "Transaction.Line.Option.Collection", "ProductLine.Common", "Backbone"], function (require, exports, _, ItemModel, TransactionLineOptionCollection, ProductLineCommon, Backbone) {
    "use strict";
    var TransactionLineModel = Backbone.Model.extend({
        ...
        initialize: function initialize(attributes) {
            ...
            this.on('change:item', function (model, item) {
                ...
                var options = model.get('options') || item_options.toJSON();
                model.set('options', options instanceof TransactionLineOptionCollection
                    ? options
                    : new TransactionLineOptionCollection(options), { silent: true });
        ...
        createFromProduct: function createFromProduct(product) {
            ...
            var is_matrix_item = !!item.get('_matrixChilds').length;
...
//# sourceMappingURL=Transaction.Line.Model.js.map
