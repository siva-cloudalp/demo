...
*/
define("UnitTestHelper.Preconditions", ["require", "exports", "underscore", "Utils"], function (require, exports, _, Utils) {
    "use strict";
    function deepExtend(obj) {
        var isNullItemFn = function (item) {
            ...
            for (var prop in source) {
                if (_.isUndefined(obj[prop]) ||
                    ...
                    if (!_.isArray(obj[prop]) || !_.isArray(source[prop])) {
                        ...
                        obj[prop] = _.reject(Utils.deepExtend(_.clone(obj[prop]), source[prop]), isNullItemFn);
                    }
                }
...
//# sourceMappingURL=UnitTestHelper.Preconditions.js.map
