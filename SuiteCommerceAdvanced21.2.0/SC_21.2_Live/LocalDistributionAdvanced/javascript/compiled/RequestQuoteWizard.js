...
*/
define("RequestQuoteWizard", ["require", "exports", "underscore", "jQuery", "Profile.Model", "Quote.Model", "RequestQuoteWizard.Router", "RequestQuoteWizard.View", "RequestQuoteWizard.Configuration", "ProductList.Model", "ProductList.Item.Model", "Transaction.Line.Model", "Backbone"], function (require, exports, _, jQuery, Profile_Model_1, Quote_Model_1, RequestQuoteWizardRouter, RequestQuoteWizardView, RequestQuoteWizardConfiguration, ProductListModel, ProductListItemModel, TransactionLineModel, Backbone) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.doRemoveItemFromList = exports.doRemoveList = exports.toggleDisableSubmitButton = exports.updateItemModels = exports.storeLinesToUpdateCollection = exports.changeQuantity = exports.doAddItemToList = exports.addLines = exports.setupPersistence = exports.mountToApp = exports.excludeFromMyAccount = void 0;
    ...
    // @return {Void}
    function setupPersistence(application, model) {
        var self = this;
    ...
    // @param {Transaction.Line.Model} product
    // @return {Void}
    function doAddItemToList(product) {
    ...
    exports.doAddItemToList = doAddItemToList;
    ...
    exports.storeLinesToUpdateCollection = new Backbone.Collection();
    // @method updateItemModels Debouncing the update quantity models
    // @return {Void}
    exports.updateItemModels = _.debounce(function () {
        var self = this;
    ...
    // @return {Void}
    function toggleDisableSubmitButton(status) {
        this.application
            .getLayout()
            .$('[data-action="submit-step"]')
            .attr('disabled', status);
    }
    exports.toggleDisableSubmitButton = toggleDisableSubmitButton;
    // @method doRemoveList
    // @return {Void}
    ...
    exports.doRemoveList = doRemoveList;
    // @method doRemoveItemFromList
    // @param {Transaction.Line.Model} product
    // @return {Void}
    function doRemoveItemFromList(product) {
        var product_list_item = {
            productList: {
                id: this.pl_internalid
            },
    ...
    exports.doRemoveItemFromList = doRemoveItemFromList;
});
