...
*/
define("Overview.Home.Standalone.View", ["require", "exports", "overview_home_standalone.tpl", "notifications.tpl", "Utils", "jQuery", "Configuration", "RecordViews.View", "AjaxRequestsKiller", "Profile.Model", "GlobalViews.Message.View", "Overview.Banner.View", "Overview.Profile.View", "Overview.Payment.View", "Overview.Shipping.View", "Backbone.CollectionView", "Session", "Handlebars", "Invoice.Collection", "Backbone", "Transaction.List.View"], function (require, exports, overview_home_standalone_tpl, notifications_tpl, Utils, jQuery, Configuration_1, RecordViews_View_1, AjaxRequestsKiller_1, Profile_Model_1, GlobalViews_Message_View_1, OverviewBannerView, OverviewProfileView, OverviewPaymentView, OverviewShippingView, BackboneCollectionView, Session, Handlebars, InvoicesCollection, Backbone, TransactionListView) {
    "use strict";
    // home page view
    var OverviewHomeStandaloneView = TransactionListView.extend({
        ...
        initialize: function (options) {
            var application = options.application, collection = options.collection, model = options.model;
            this.application = application;
            this.collection = collection || new InvoicesCollection();
            this.model = model || Profile_Model_1.ProfileModel.getInstance();
        ...
        beforeShowContent: function beforeShowContent() {
            ...
            var defaultRecentOrdersQuantity = 10;
            this.collection
                .fetch({
                data: {
                    page: 1,
                    ...
                    results_per_page: Configuration_1.Configuration.get('overview.homeRecentOrdersQuantity', defaultRecentOrdersQuantity)
                },
                ...
                var records_collection = new Backbone.Collection(this.collection.map(function (invoice) {
                    invoice.status.name =
                        invoice.get('status').internalid === 'open'
                            ? new Handlebars.SafeString(Utils.translate('<span class="invoice-pending">Pending</span>'))
                            : new Handlebars.SafeString(Utils.translate('<span class="invoice-paid">Paid</span>'));
        ...
        getSelectedMenu: function () { return 'home'; },
        getBreadcrumbPages: function () { return []; },
    ...
    return OverviewHomeStandaloneView;
});

//# sourceMappingURL=Overview.Home.Standalone.View.js.map
