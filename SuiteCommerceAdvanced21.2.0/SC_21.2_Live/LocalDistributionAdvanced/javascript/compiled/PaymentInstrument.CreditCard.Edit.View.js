...
*/
define("PaymentInstrument.CreditCard.Edit.View", ["require", "exports", "underscore", "paymentinstrument_creditcard_edit.tpl", "creditcard_edit.tpl", "Loggers", "Utils", "jQuery", "Configuration", "Profile.Model", "CreditCard.Edit.Form.View", "PaymentInstrument.CreditCard.Edit.Form.View", "PaymentInstrument.CreditCard.Model", "LiveOrder.Model", "Backbone", "Backbone.View", "Backbone.FormView"], function (require, exports, _, paymentinstrument_creditcard_edit_tpl, creditcard_edit_tpl, Loggers_1, Utils, jQuery, Configuration_1, Profile_Model_1, CreditCardEditFormView, PaymentInstrumentCreditCardEditFormView, PaymentInstrumentCreditCardModel, LiveOrderModel, Backbone, BackboneView, BackboneFormView) {
    "use strict";
    // @class PaymentInstrument.CreditCard.Edit.View card details view/edit @extends Backbone.View
    var PaymentInstrumentCreditCardEditView = BackboneView.extend({
        attributes: {
        ...
        initialize: function (options) {
            ...
            var addCCLabel = Utils.translate('Add Credit Card');
            var editCCLabel = Utils.translate('Edit Credit Card');
            ...
            var newExpYear = new Date().getFullYear();
            var range = _.range(new Date().getFullYear(), new Date().getFullYear() + 25);
            ...
            this.options.showDefaults =
                Configuration_1.Configuration.get('currentTouchpoint') === 'customercenter' ||
                    Configuration_1.Configuration.get('siteSettings.checkout.showsavecreditinfo') === 'T';
            this.allowTemporalCreditCard =
                Configuration_1.Configuration.get('currentTouchpoint') === 'checkout' ||
                    (Configuration_1.Configuration.get('currentTouchpoint') === 'customercenter' &&
                        this.options.allowTemporalCreditCard &&
                        !SC.ENVIRONMENT.paymentInstrumentEnabled);
            this.showSaveCreditCardCheckbox =
                Configuration_1.Configuration.get('siteSettings.checkout.showsavecc', 'T') === 'T' &&
                    this.allowTemporalCreditCard;
            this.saveCreditCardByDefault =
                Configuration_1.Configuration.get('siteSettings.checkout.saveccinfo', 'T') === 'T' &&
                    this.allowTemporalCreditCard;
        ...
        saveForm: function (e) {
            ...
            var promise;
            if (this.allowTemporalCreditCard &&
                ...
                if (result) {
                    var paymentmethods = Configuration_1.Configuration.get('siteSettings.paymentmethods');
                ...
                var actionId_1 = loggers_1.start('Save Credit Card');
        ...
        setPaymethodKey: function (e) {
            ...
            var paymenthod_key = this.paymenthodKeyCreditCart(cc_number);
    ...
    return PaymentInstrumentCreditCardEditView;
});
...
//# sourceMappingURL=PaymentInstrument.CreditCard.Edit.View.js.map
