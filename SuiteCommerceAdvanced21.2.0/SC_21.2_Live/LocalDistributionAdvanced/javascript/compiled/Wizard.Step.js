...
*/
define("Wizard.Step", ["require", "exports", "underscore", "wizard_step.tpl", "Utils", "jQuery", "GlobalViews.Message.View", "Backbone", "Backbone.View", "PluginContainer"], function (require, exports, _, wizard_step_tpl, Utils, jQuery, GlobalViews_Message_View_1, Backbone, BackboneView, PluginContainer) {
    "use strict";
    // @class Wizard.Step Step View, Renders all the components of the Step @extends {Backbone.View}
    var WizardStep = BackboneView.extend({
        ...
        getContinueButtonLabel: function () {
            ...
            var label = this.continueButtonLabel;
            if (current_step) {
        ...
        hasErrors: function () {
            return (this.error ||
                _.some(this.moduleInstances, function (module) {
                    return module.error;
                }));
        },
        // @method  showError
        ...
        areAllModulesReady: function () {
            var ready_state_array = _(this.moduleInstances)
                .chain()
                .pluck('isReady')
                .uniq()
                .value();
        ...
        moduleNavbarToggle: function (module, toggle) {
            ...
            this.renderPromise.done(function () {
                ...
                var toggle_state_array = _(self.moduleInstances)
                    .chain()
        ...
        render: function () {
            ...
            _.each(this.moduleInstances, function (module_instance) {
                ...
                var container = module_instance.options.container;
                if (container) {
                    var added = false;
        ...
        showStep: function () {
            return (this.isActive() &&
                _.some(_.filter(this.moduleInstances, function (module_to_filter) {
