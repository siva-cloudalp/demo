...
*/
define("Content.EnhancedViews", ["require", "exports", "underscore", "jQuery", "Content.DataModels", "Backbone.View", "Backbone.View.render", "Backbone.View.Plugins"], function (require, exports, _, jQuery, DataModels) {
    "use strict";
    ...
    _.extend(EnhancedViews, {
        ...
        overrideViewSettings: function (view, page) {
            ...
            var default_page = default_url && DataModels.Pages.Collection.getInstance().get(default_url.get('pageid'));
            if (default_page) {
        ...
        enhanceMetaTags: function (view) {
            ...
            if (addToHead) {
                jQuery('<script id="enhanceMetaTagsStart"></script>' +
                    addToHead +
                    '<script id="enhanceMetaTagsEnd"></script>').appendTo(this.$head);
            }
            return this;
        },
        ...
        renderHTMLContent: function (view, content_zone) {
            ...
            var layout = view.options.application.getLayout();
...
//# sourceMappingURL=Content.EnhancedViews.js.map
