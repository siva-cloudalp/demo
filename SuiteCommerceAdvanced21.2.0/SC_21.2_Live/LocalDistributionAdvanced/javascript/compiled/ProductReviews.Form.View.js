...
*/
define("ProductReviews.Form.View", ["require", "exports", "underscore", "product_reviews_form.tpl", "Utils", "jQuery", "Configuration", "AjaxRequestsKiller", "Profile.Model", "Product.Model", "ProductReviews.Model", "ProductReviews.FormPreview.View", "ProductReviews.FormConfirmation.View", "Facets.ItemCell.View", "GlobalViews.StarRating.View", "Backbone", "Backbone.View", "Backbone.CollectionView", "Backbone.FormView"], function (require, exports, _, product_reviews_form, Utils, jQuery, Configuration_1, AjaxRequestsKiller_1, Profile_Model_1, ProductModel, ProductReviewsModel, ProductReviewsFormPreviewView, ProductReviewsFormConfirmationView, FacetsItemCellView, GlobalViewsStarRatingView, Backbone, BackboneView, BackboneCollectionView, BackboneFormView) {
    "use strict";
    ...
    var ProductReviewsFormView = BackboneView.extend({
        ...
        beforeShowContent: function beforeShowContent() {
            ...
            var data;
            if (this.routerArguments.length === 3 &&
        ...
        rate: function (e, rater) {
            ...
            if (!this.rateTouched && Configuration_1.Configuration.get('productReviews.computeOverall')) {
        ...
        childViews: {
            ...
            'Global.StarRatingAttribute': function () {
                var self = this;
                var collection = new Backbone.Collection(_.map(this.item.get('_attributesToRateOn'), function (value) {
                    return {
                        label: value,
                        name: value,
        ...
        getContext: function () {
            ...
            return {
                ...
                isLoginRequiredAndIsNotLoggedIn: Configuration_1.Configuration.get('productReviews.loginRequired') && !this.isLoggedIn,
...
//# sourceMappingURL=ProductReviews.Form.View.js.map
