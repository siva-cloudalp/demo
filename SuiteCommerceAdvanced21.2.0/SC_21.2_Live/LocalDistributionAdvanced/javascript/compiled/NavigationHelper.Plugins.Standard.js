...
*/
define("NavigationHelper.Plugins.Standard", ["require", "exports", "underscore", "Utils", "Backbone", "UrlHelper"], function (require, exports, _, Utils, Backbone) {
    "use strict";
    ...
    var standardPlugins = {
        ...
        correctURL: function (layout, e) {
            ...
            var window_obj = Utils.getWindow();
            ...
            if (!context.target_data.touchpoint && !standardPlugins.isNOTURLHashtagPart(href)) {
                ...
                else if (window_obj.location.href.lastIndexOf('#') ===
        ...
        clickNavigation: function (layout, e) {
            ...
            var target_is_modal_or_pusher = context.target_data.toggle === 'show-in-modal' ||
...
//# sourceMappingURL=NavigationHelper.Plugins.Standard.js.map
