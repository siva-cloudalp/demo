...
*/
define("ProductLine.Common", ["require", "exports", "underscore", "Configuration", "ProductLine.Common.Url", "ProductLine.Common.Image"], function (require, exports, _, Configuration_1, ProductLineCommonUrl, ProductLineCommonImage) {
    "use strict";
    ...
    var ProductLineCommon = {
        ...
        getVisibleOptions: function getVisibleOptions() {
            var collection;
            if (Configuration_1.Configuration.get('ItemOptions.showOnlyTheListedOptions')) {
                collection = this.get('options').filter(function (option) {
                    return _.find(Configuration_1.Configuration.get('ItemOptions.optionsConfiguration'), function (optionConfiguration) {
        ...
        extendOptionsFromItem: function extendOptionsFromItem(item, productline) {
            ...
            item.get('options').each(function (item_option) {
                ...
                var productline_option = productline.get('options').find(function (product_option) {
...
//# sourceMappingURL=ProductLine.Common.js.map
