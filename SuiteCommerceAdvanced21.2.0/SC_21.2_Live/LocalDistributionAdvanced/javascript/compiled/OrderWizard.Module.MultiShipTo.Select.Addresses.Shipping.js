...
*/
define("OrderWizard.Module.MultiShipTo.Select.Addresses.Shipping", ["require", "exports", "underscore", "order_wizard_msr_addresses_module.tpl", "Utils", "jQuery", "OrderWizard.Module.Address"], function (require, exports, _, order_wizard_msr_addresses_module_tpl, Utils, jQuery, OrderWizardModuleAddress) {
    "use strict";
    // @class OrderWizard.Module.Address @extend Wizard.Module
    var OrderWizardModuleMultiShipToSelectAddressesShipping = OrderWizardModuleAddress.extend({
        ...
        initialize: function () {
            ...
            self.atLeastTwoValidAddressesErrorMessage.errorMessage = Utils.translate('You need at least $(0) valid shipping addresses', this.minValidAddressesQuantity);
        ...
        getContext: function () {
            ...
            return {
                ...
                showCollapsedView: !!(this.options.hide_if_valid_addresses &&
    ...
    return OrderWizardModuleMultiShipToSelectAddressesShipping;
});

//# sourceMappingURL=OrderWizard.Module.MultiShipTo.Select.Addresses.Shipping.js.map
