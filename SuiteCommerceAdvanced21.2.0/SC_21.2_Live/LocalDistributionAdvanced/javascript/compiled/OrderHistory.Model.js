...
*/
define("OrderHistory.Model", ["require", "exports", "Utils", "Transaction.Model", "Transaction.Collection", "OrderHistory.Line.Collection", "ReturnAuthorization.Collection"], function (require, exports, Utils, TransactionModel, TransactionCollection, OrderHistoryLineCollection, ReturnAuthorizationCollection) {
    "use strict";
    // @class OrderHistory.Model Model for showing information about past orders @extend Transaction.Model
    var OrderHistoryModel = TransactionModel.extend({
