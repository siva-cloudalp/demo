...
*/
define("Backbone.CompositeView.Fade", ["require", "exports", "underscore", "jQuery"], function (require, exports, _, jQuery) {
    "use strict";
    var BackboneCompositeViewFade = {
        /**
        ...
        fadeViews: function (fadeFromViewName, fadeToViewName) {
            var self = this;
            var fadeFrom = this.getChildViewInstance(fadeFromViewName);
            var fadeTo = this.renderChild(fadeToViewName);
            if (!fadeFrom || !fadeTo) {
                return;
            }
        ...
        fadeOutView: function (childViewName) {
            var self = this;
            var fadeTo = this.getChildViewInstance(childViewName);
            if (!fadeTo) {
                return;
            }
    ...
    return BackboneCompositeViewFade;
});

//# sourceMappingURL=Backbone.CompositeView.Fade.js.map
