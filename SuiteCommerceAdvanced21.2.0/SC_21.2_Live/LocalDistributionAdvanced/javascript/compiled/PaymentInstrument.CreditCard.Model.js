...
*/
define("PaymentInstrument.CreditCard.Model", ["require", "exports", "underscore", "Utils", "PaymentMethod.Model"], function (require, exports, _, Utils, PaymentMethod_Model_1) {
    "use strict";
    ...
    var PaymentInstrumentCreditCardModel = PaymentMethod_Model_1.PaymentMethodModel.extend({
        ...
        validation: {
                ...
                fn: function (cc_number, attr, form) {
                    ...
                    if (_.isUndefined(form.internalid)) {
                        ...
                        var card_number_is_valid = _(cc_number.split('').reverse()).reduce(function (a, n, index) {
                            return (a +
                                _((+n * [1, 2][index % 2]).toString().split('')).reduce(function (b, o) {
                                    return b + +o;
                                }, 0));
                        }, 0) %
                            10 ===
                        ...
                        if (!(cc_number.length >= 13 && cc_number.length <= 20)) {
                            return Utils.translate('Credit card numbers must contain between 13 and 20 digits');
                        }
                    }
                }
            },
            ...
            ccsecuritycode: {
                fn: function (cc_security_code) {
                    if (SC.ENVIRONMENT.siteSettings.checkout.requireccsecuritycode === 'T' &&
                        (this.hasSecurityCode || this.get('hasSecurityCode'))) {
                        var errorMessage = Utils.validateSecurityCode(cc_security_code);
                        if (errorMessage) {
                            return errorMessage;
                        }
                    }
    ...
    return PaymentInstrumentCreditCardModel;
});

//# sourceMappingURL=PaymentInstrument.CreditCard.Model.js.map
