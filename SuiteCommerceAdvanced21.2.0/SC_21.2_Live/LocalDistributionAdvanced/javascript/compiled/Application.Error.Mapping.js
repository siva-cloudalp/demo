...
*/
define("Application.Error.Mapping", ["require", "exports", "Utils"], function (require, exports, Utils) {
    "use strict";
    var ApplicationErrorMapping = {
        ...
        ERR_INSUFFICIENT_PERMISSIONS: {
            message: Utils.translate('You do not have permission to perform this action. Contact an administrator to ensure you have the correct permissions.')
        },
        ERR_RECORD_NOT_FOUND: {
            message: Utils.translate('Record is not found.')
        },
        ERR_METHOD_NOT_ALLOWED: {
            message: Utils.translate('This action is not allowed. Contact an administrator to ensure you have the correct permissions.')
        },
        ERR_INVALID_ITEMS_FIELDS_ADVANCED_NAME: {
            message: Utils.translate('Contact an administrator to check if the field set has been created.')
        },
        // !***** SCIS ERRORS *****
        ORDER_REQUIRED: {
        ...
        NOT_APPLICABLE_CREDIT_MEMO: {
            message: Utils.translate('Credit Memo is not applicable to this order. Assign the customer on the credit memo to the invoice, and then verify the credit memo balance.')
        },
        ...
        INVALID_RETURNED_QUANTITY: {
            message: Utils.translate('The quantity being returned exceeds the available quantity. (Line $(0))')
        },
        CUSTOMER_NOT_FOUND: {
        ...
        NOT_FOUND_EMPLOYEE_LOCATION: {
            message: Utils.translate('The current user is not associated with a location. A location must be selected on the employee record.')
        },
        REQUIRED_SALES_ASSOCIATE_LOCATION: {
            message: Utils.translate('The sales associate requires a location to create the order. A location must be selected on the employee record.')
        },
        INVALID_TRANSACTION_TYPE: {
            message: Utils.translate('Transaction type is not valid: $(0)')
        },
        LOCATION_ADDRESS_MISSING_FIELDS: {
            message: Utils.translate('Location address is missing required information. Please complete the form to proceed. $(0)')
        },
        ...
        MISSING_DRAWER_CONFIGURATION: {
            message: Utils.translate('SCIS STORE SAFE ACCOUNT and SCIS CASH DRAWER DIFFERENCE fields are not configured for the current location. An administrator must make this change.')
        },
        ...
        CASH_DRAWER_IS_BEIGN_USED: {
            message: Utils.translate('This cash drawer is being used by:  $(0), please select a diferent one.')
        }
        // !***** END SCIS ERROR *****
    };
...
//# sourceMappingURL=Application.Error.Mapping.js.map
