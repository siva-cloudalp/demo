...
*/
define("ProductReviews.Collection", ["require", "exports", "underscore", "Utils", "Configuration", "ProductReviews.Model", "Backbone.CachedCollection"], function (require, exports, _, Utils, Configuration_1, Model, BackboneCachedCollection) {
    "use strict";
        ...
        getReviewParams: function (options) {
            ...
            if (options) {
                ...
                if (options.filter) {
                    ...
                    filter =
                        _.find(Configuration_1.Configuration.get('productReviews.filterOptions'), function (i) {
                ...
                if (options.sort) {
                    ...
                    sort =
                        _.find(Configuration_1.Configuration.get('productReviews.sortOptions'), function (i) {
                ...
                // and we add it to the reviews_params obj
                var params = options.order === 'inverse'
...
//# sourceMappingURL=ProductReviews.Collection.js.map
