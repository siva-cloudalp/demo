...
export function mountToApp(application) {
    ...
    // @return {Void}
export function setupPersistence(application, model) {
        const self = this;
    ...
    // @return {Void}
export function addLines(product) {
        const self = this;
    ...
    // @param {Transaction.Line.Model} product
    // @return {Void}
export function doAddItemToList(product) {
    ...
    // @return {Void}
export function changeQuantity(line) {
...
export const storeLinesToUpdateCollection = new Backbone.Collection();

    // @method updateItemModels Debouncing the update quantity models
    // @return {Void}
export const updateItemModels = _.debounce(function() {
        const self = this;
    ...
    // @return {Void}
export function toggleDisableSubmitButton(status) {
        this.application
            .getLayout()
...
export function doRemoveList() {
    ...
    // @param {Transaction.Line.Model} product
    // @return {Void}
export function doRemoveItemFromList(product) {
        const product_list_item = {
            productList: {
                id: this.pl_internalid
            },
