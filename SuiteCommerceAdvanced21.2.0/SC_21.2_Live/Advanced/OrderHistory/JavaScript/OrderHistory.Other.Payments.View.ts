...
/// <amd-module name="OrderHistory.Other.Payments.View"/>

import * as _ from 'underscore';

import * as order_history_other_payments_tpl from 'order_history_other_payments.tpl';

import BackboneView = require('../../../Commons/BackboneExtras/JavaScript/Backbone.View');

// @class OrderHistory.Other.Payments.View @extend Backbone.View
const OrderHistoryOtherPaymentsView: any = BackboneView.extend({
    ...
    getContext: function() {
        return {
            ...
            showDepositApplications:
                this.depositApplications && this.depositApplications.length > 0,
...
export = OrderHistoryOtherPaymentsView;
